...
public class AddPhonecallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_phonecall);
    ...
    public void onStart() {
        ...
        callerBox = findViewById(R.id.callerTextBox);
        calleeBox = findViewById(R.id.calleeTextBox);
    ...
    public void onResume() {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean callerOK = ErrorChecker.callChk(callerBox);
                boolean calleeOK = ErrorChecker.callChk(calleeBox);
                ...
                boolean allChksPass = custOK && callerOK && calleeOK && startDateOK && startTimeOK &&
                                      startSuffixOK && endDateOK && endTimeOK && endSuffixOK;

                if(allChksPass){
                    Context context = view.getContext();
                    String customer = custBox.getText().toString();
                    String caller = callerBox.getText().toString();
                    String callee = calleeBox.getText().toString();
                    ...
                    pBills.addPhoneCall(customer, caller, callee, start, end);

                    Toast toast = Toast.makeText(context, "Phone call added!", Toast.LENGTH_SHORT);
                    toast.show();
